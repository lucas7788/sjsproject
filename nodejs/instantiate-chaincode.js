...
//instantiateTxn(CFGS.chaincodePath, 'usertable', 'v0');
instantiateTxn(CFGS.chaincodePath, 'excc3', 'v0',['a','100','b','200']);
...
function instantiateTxn(ccp, ccid, ccv, argsUsed){
    var tx_id = null;
    var nonce = null;
    var the_user = null;
    var allEventhubs = [];
    
    // this is a transaction, will just use org1's identity to submit the request
    var org = CFGS.org;
    var client = new hfc();
    ...
    // set up the chain to use each org's 'peer1' for both requests and events
    for (let key in ORGS) {
...
exports.instantiateTxn = instantiateTxn;
